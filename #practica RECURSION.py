...
#Ejercicio 0:
# scriba una función recursiva factorial que tome un numero natural n y calcule su factorial n!
...
# Ejercicio 4: Considere la siguiente función recursiva:
def f(n, d):
    if n > 1:
        if n % d == 0:
            print(d)
